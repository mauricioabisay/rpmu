				...
				<fieldset>
					...
					@foreach ( $research->requirements as $requirement )
						<div class="form-inline rpm-dynamic-list-item">
							<input type="hidden" class="delete" name="requirement_delete[]" value="0">
				...
				<fieldset>
					...
					@foreach ( $research->goals as $goal )
						<div class="form-inline rpm-dynamic-list-item" rpm-dynamic-list-prefix="goal">
							<input class="delete" type="hidden" name="goal_delete[]" value="0">
				...
				<fieldset>
					...
					<div class="form-group">
						<input 
							...
							class="form-control rpm-api-search-slug" 
							rpm-api="{{ url('api/participants') }}" 
							rpm-api-list="leader-list"
							rpm-api-result-id="id" 
							rpm-api-result-human="name"
							rpm-api-input="leader">
						<input type="hidden" name="leader" id="leader" value="{{ ( !$leader ) ? '-1' : $leader->id }}" >
						<ul id="leader-list" class="rpm-api-list"></ul>
					</div>
				</fieldset>
				<fieldset>
